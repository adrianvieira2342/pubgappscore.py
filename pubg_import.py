...
try:
    ...
    for player in players:
        ...
        if not res_p or res_p.status_code != 200: continue
        ...
        if res_s and res_s.status_code == 200:
            ...
            if partidas > 0:
                ...
                """
                cursor.execute(sql, (player, partidas, kr, vitorias, kills, dano_medio, assists, headshots, revives, dist_max, datetime.utcnow()))
                conn.commit()
